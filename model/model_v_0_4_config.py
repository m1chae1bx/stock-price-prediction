...
DATA_FILENAME_MAP = {
    ...
    "SCC": {"filename": "SCC_1995_2022.csv", "metadata": "SCC_1995_2022_metadata.json"},
    "SEVN": {"filename": "SEVN_1995_2022.csv", "metadata": "SEVN_1995_2022_metadata.json"},
    "SMPH": {"filename": "SMPH_1995_2022.csv", "metadata": "SMPH_1995_2022_metadata.json"},
    "MER": {"filename": "MER_1995_2022.csv", "metadata": "MER_1995_2022_metadata.json"},
    "GLO": {"filename": "GLO_1995_2022.csv", "metadata": "GLO_1995_2022_metadata.json"},
    "GMA7": {"filename": "GMA7_1995_2022.csv", "metadata": "GMA7_1995_2022_metadata.json"},
    "DITO": {"filename": "DITO_1995_2022.csv", "metadata": "DITO_1995_2022_metadata.json"},
    "PAL": {"filename": "PAL_1995_2022.csv", "metadata": "PAL_1995_2022_metadata.json"},
}
TRAINING_SET = [
    "FB",  # Food, Beverage & Tobacco
    "MAXS",  # Food, Beverage & Tobacco
    "AC",  # Holding Firms
    "SMPH",  # Property
    "BDO",  # Banks
    "GLO",  # Telecommunications
    "DITO",  # Information Technology
    "PAL",  # Transportation Services
    "MER",  # Electricity, Energy, Power & Water
    "SCC",  # Mining
    "SEVN",  # Retail
    "GMA7",  # Media
]
...
BASELINE_MODEL_FILENAME = "v_0_3/model.h5"
